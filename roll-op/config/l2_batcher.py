class L2BatcherConfig:
    ...
    def __init__(self):
        ...
        self.plasma_da_server = "http://127.0.0.1:3100"
        """
        HTTP address of a DA Server (default: "http://127.0.0.1:3100").
        """

        self.plasma_da_service = True
        """
        Use DA service type where commitments are generated by plasma server (default: False).
        """
